...
<div class="tabel-page">
    ...
    <div class="search-box">
        <form method="get" action="#">
            ...
            <label for="ftingkat"> Tingkat: <input type="tingkat" name="tingkat" type="text">
            </label>
            <datalist id="tingkat">
            ...
            <button class="button-input" id="myBtn" type="submit">
                <i class="fa fa-search" aria-hodden="true"></i>search 
            </button>
        </form>
    </div>
            ...
            ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="button-edit" id="bittonedit">
...
?>
    <div class="tabel-page">
        ...
        <div class="button-container">
            <button class="button-input" id="myBtn" onclick="show-modal(0)">
        ...
        <table id="list-data" class="display">
            ...
            ?>
                ...
                <div id="myModal<?php echo $i?>" clas="modal">
                    <!-- Modal content --> 
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form name="input" method="post" action="nilai/nilai_update.php">
                                ...
                                <input type="text" id="fnama" name="nama" value="<?php echp $row['Nama_Mhs']?>" readonly>
                                <label for="fmatkul">Nama Matkul</label>
    ...
    <div id="myModal0" class="modal">
        <div class="modal-conten">
            ...
            <input type="text" id="fnilai" name="nilai" list="nilai" placholder="Nilai">
                <datalis id="nilai">
                    <option value="A">A</option>
