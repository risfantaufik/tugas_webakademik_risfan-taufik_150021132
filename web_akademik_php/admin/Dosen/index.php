    ...
    <table id="list-data" class="display">
        ...
        ?>
               ...
               <!--Menampilkan Data Dosen -->
                ...
                <!-- Modal Update Data -->
                <div id="myModal<?php $i?>" class="modal">
                    <!-- Modal content -->
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form name="input" method="post" action="dosen/dosen_update.php">
                                ...
                                <input type="text" id="fid" name="id" value="<?php echo $row['ID_Dosen']?>" maxlength="7" reguired>
                                <label for="fnama">Nama</label>
                                <input type="text" id="fnama" nama="nama" value="<?php echo $row['Nama_Dosen']?>" reguired>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form name="input" method="post" action="dosen/dosen_input.php">
                ...
                <label for="fnama">Nama</label>
                <input type="text" id="fnama" name="nama" placholder="Nama" required>
                <input type="submit">
            </form>
         </div>
    </div>
