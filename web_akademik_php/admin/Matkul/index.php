...
<div class ="tabel-page">
    ...
    <table id="list-data" class="display">
        ...
        <?php
            include"../comfig/db_connection.php";
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form name="input" method="post" action="matkul/matkul_update.php">
                                ...
                                <input type="number" id="fsemester" name="semester" value="<?php echo $row['Semester']?>" required mun=1>
...
<div id="myModal0" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <form name="inpur" method="post" action="matkul/matkul_input.php">
        <label for="fid">ID Matkul</label>
